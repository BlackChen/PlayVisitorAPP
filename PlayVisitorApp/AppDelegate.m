...
@interface AppDelegate () <UISplitViewControllerDelegate>{
    UIViewController *loginVC,*homeVC,*joyVC,*otherVC,*personVC;
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //    友盟key
    [UMSocialData setAppKey:@"56ef8715e0f55a24d90003ed"];
    //     添加QQ分享
    [UMSocialQQHandler setQQWithAppId:@"1105197917" appKey:@"QNspJNXgCPC0zMKp" url:nil];
    //    新浪
    ...
    loginStatusStr = @"";
    if ([loginStatusStr isEqual:@"YES"]) {
        self.viewController = self.tabBarVC;
    }else{
...
- (void)customizeInterface {
    ...
    if (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_6_1) {
        ...
        textAttributes = @{NSFontAttributeName: [UIFont boldSystemFontOfSize:18],NSForegroundColorAttributeName: [UIColor purpleColor],};
    } else {
#if __IPHONE_OS_VERSION_MIN_REQUIRED < __IPHONE_7_0
        backgroundImage = [UIImage imageNamed:@"navigationbar_background"];
        textAttributes = @{UITextAttributeFont: [UIFont boldSystemFontOfSize:18], UITextAttributeTextColor:[UIColor purpleColor],UITextAttributeTextShadowColor:[UIColor clearColor],UITextAttributeTextShadowOffset:[NSValue valueWithUIOffset:UIOffsetZero],};
#endif
    }
    [navigationBarAppearance setBackgroundImage:backgroundImage forBarMetrics:UIBarMetricsDefault];
    [navigationBarAppearance setTitleTextAttributes:textAttributes];
    [navigationBarAppearance setBackgroundColor:[UIColor purpleColor]];
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.BCSoft.PlayVisitorApp" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"PlayVisitorApp" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"PlayVisitorApp.sqlite"];
    NSError *error = nil;
